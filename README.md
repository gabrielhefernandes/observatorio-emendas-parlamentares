...
[![Assista à demonstração completa no YouTube](imagens/demo.gif)](https://youtu.be/kmRy-mHkiUQ)

> **Clique no GIF acima para assistir à demonstração detalhada com áudio no YouTube**.
